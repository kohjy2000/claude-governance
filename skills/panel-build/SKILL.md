...
- Relevant `docs/` excerpts (CLAIMS entry for this panel, STORY context)
...
- Multi-modal review (Vision LM): if available, use to catch label overlap / color contrast issues that code review misses. Delegates to figure-reviewer subagent with multimodal=true.
